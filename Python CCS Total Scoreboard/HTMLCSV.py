files = [["Totals.csv","Web/Totals.html"],["JuniorTotals.csv","Web/JuniorTotals.html"],["SeniorTotals.csv","Web/SeniorTotals.html"]]
time_tag = "{TIME}"
row_tag = "<!--{ROW}-->"
row_end = "<!--{/ROW}-->"
...
for file in files:
    ...
    templatefile = open("TotalsTemplate.html","r")
