...
rounds = [["Round1",options["round1_filename"],1,options["round1_senior_images"]],["Round2",options["round2_filename"],2,options["round2_senior_images"]],["Round3",options["round3_filename"],3,options["round3_senior_images"]]]
division = ["Division",options["division_filename"]]
...
category_lookup = options["categories"]

csvfile = open(options["totals"],"w")
csvfile.write("Team ID,Scored Images Category,Total CCS Score,Division\n")
data = DB.run_sql(totals_sql_div)
for i in data:
    csvfile.write("%s,%s,%s,%s\n" % (i[0],category_lookup[str(int(i[1]))],i[2],i[3]))
csvfile.close()

csvfile = open(options["junior_totals"],"w")
csvfile.write("Team ID,Scored Images Category,Total CCS Score,Division\n")
...
csvfile = open(options["senior_totals"],"w")
csvfile.write("Team ID,Scored Images Category,Total CCS Score,Division\n")
